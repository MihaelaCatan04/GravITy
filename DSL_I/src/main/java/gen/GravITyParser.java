...
public class GravITyParser extends Parser {
	...
	public static class X_velocity_exprContext extends ParserRuleContext {
		...
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GravITyListener) ((gen.GravITyListener)listener).exitX_velocity_expr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Loop_valueContext extends ParserRuleContext {
		...
		public TerminalNode INTEGER() { return getToken(GravITyParser.INTEGER, 0); }
